...
describe("Product gallery manager client", () => {
  ...
  it("should get 10 start wars cards", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith(
      "http://ec2-3-23-123-190.us-east-2.compute.amazonaws.com:8080/api/v1/cards?page=1&limit=10",
      {
        method: "GET",
      }
    );
  ...
  it("should get a start wars card with id = 01003", async () => {
    ...
    expect(fetch).toHaveBeenCalledTimes(1);
    expect(fetch).toHaveBeenCalledWith(
      "http://ec2-3-23-123-190.us-east-2.compute.amazonaws.com:8080/api/v1/card?cardId=01003",
      {
        method: "GET",
      }
    );
